...
- Node.js 18+
- PostgreSQL (local ou serviço como Supabase, Neon ou Vercel Postgres)
- Conta na [Anthropic](https://console.anthropic.com/) para a chave da API
- Conta no [Resend](https://resend.com/) para envio de emails
- Conta no [Upstash](https://upstash.com/) para rate limiting (opcional em dev)
...
git clone https://github.com/joaovitor8/ControleFinanceiro.git
cd ControleFinanceiro/app
...
Crie um arquivo `.env` na raiz de `app/` com as seguintes variáveis:
...
# Opcional: sobrescreve o modelo padrão (claude-opus-4-7)
# CLAUDE_MODEL="claude-sonnet-4-6"

# Resend (emails de verificação e reset de senha)
RESEND_API_KEY="re_..."
EMAIL_FROM="FinSmart <noreply@seudominio.com>"

# URL pública da aplicação (usada nos links dos emails)
APP_URL="http://localhost:3000"

# Upstash Redis (rate limiting distribuído)
# Opcional em dev — cai em fallback em memória se ausente
UPSTASH_REDIS_REST_URL="https://..."
UPSTASH_REDIS_REST_TOKEN="..."
```

> Em produção, `UPSTASH_REDIS_REST_URL` e `UPSTASH_REDIS_REST_TOKEN` são **obrigatórios**.
